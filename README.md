# ğŸŒ Jarvis Spatial Command Shell (v2.2)
...
<p align="center">
  <b>ğŸ¬ <a href="demo.mp4">Demo-Video ansehen / Watch Demo (MP4)</a></b>
</p>

---

<p align="center">
  <a href="#--deutsch"><b>Deutsch</b></a> | <a href="#--english"><b>English</b></a>
</p>
...
* **Holografischer Sub-Bubble Ring:** Schwebt der Cursor ´ber einem Knoten, steigen 4 rotierende Sub-Orbit-Blasen mit Vektordräh4en auf.
* **Sci-Fi HUD:** Projektion von gestochen scharfen Vektorlinien mit Zielpfad, Typ und Status bei Mouseover.
* **Echtzeit-PipeWire-FFT:** Direkter Zugriff auf den Monitor-Sink deiner aktiven Soundkarte (HDMI, Klinke, DAC).
* **Entkoppeltes Control Deck (5 Tabs):** Einstellungsfenster dockt mit Abstand über/neben der Kugel an â€“ kein Verdecken des Renderings beim Konfigurieren.

### ğŸ Steuerung & Tastenkürzel

| Taste / Aktion | Funktion |
| :--- | :--- |
| **E`** | Schaltet den Bearbeitungsrahmen und das Zahnrad (âš™) AN oder AUS |
| **C`** | Öffnet/SchlieÆt das Control Deck jederzeit |
...
| **Klick auf Knoten** | Offnet Ordner via xdg-open oder führt hinterlegtes Tool aus |
| **Ctrl + Shift + J*** | Globaler System-Shortcut zum Starten/Beenden |
| **Terminal: jarvis-orb** | Togglet die Shell unabhängig vom Terminal |
